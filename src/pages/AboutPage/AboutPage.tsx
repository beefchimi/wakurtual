    ...
    <div className={styles.AboutPage}>
      ...
      <section className="typography">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              <code>repeat &gt; auto-fill &gt; min/max</code> pattern. This
              allows items to wrap automatically when an item would otherwise
              cross it’s <code>min</code> boundary.
            </p>
          </li>
          <li>
            <p>
              There may be some instances of <code>@media</code> queries to
              adjust the <code>min</code> item size. Otherwise, there is no
              explicit code to govern the exact number of items per-row within a
              specific width range. Item wrapping is simply a consequence of the
              CSS grid auto-fill layout mode.
            </p>
          </li>
        </ul>
        ...
        <p>
          ...
          executed server-side, using <code>Waku</code> affords me the
          opportunity to dig deeper and surface some of my findings in the UI.
        </p>
      </section>
    </div>
  );
